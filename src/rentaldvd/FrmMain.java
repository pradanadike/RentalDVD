...
public class FrmMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(124, 179, 66));
        jPanel1.setLayout(null);

        btMn1.setBackground(new java.awt.Color(255, 255, 255));
        btMn1.setText("Penyewaan");
        ...
        jPanel1.add(btMn2);
        btMn2.setBounds(20, 330, 180, 32);

        btMn4.setBackground(new java.awt.Color(255, 255, 255));
        btMn4.setText("Riwayat");
        ...
        jPanel1.add(btMn4);
        btMn4.setBounds(20, 370, 180, 32);

        jPanel2.setBackground(new java.awt.Color(104, 159, 56));
        jPanel2.setLayout(null);

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("\"DIKE\"");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(0, 20, 190, 30);
        ...
        jPanel2.add(jLabel3);
        jLabel3.setBounds(0, 40, 190, 30);

        jPanel1.add(jPanel2);
        jPanel2.setBounds(10, 10, 200, 90);
        ...
        jLabel6.setForeground(new java.awt.Color(104, 159, 56));
        ...
        jLabel8.setForeground(new java.awt.Color(104, 159, 56));
        jLabel8.setText("Barang Masuk");
        pnl2.add(jLabel8);
        jLabel8.setBounds(30, 20, 270, 50);

        jLabel9.setText("Judul DVD");
        pnl2.add(jLabel9);
        ...
        pnl2.add(jLabel12);
        jLabel12.setBounds(30, 260, 200, 16);
        pnl2.add(tbHarga);
        ...
        jLabel13.setForeground(new java.awt.Color(104, 159, 56));
        ...
        jButton3.setBackground(new java.awt.Color(104, 159, 56));
        jButton3.setText("Sudah Kembali");
        ...
        pnl3.add(jButton3);
        jButton3.setBounds(324, 280, 140, 32);

        getContentPane().add(pnl3);
        pnl3.setBounds(220, 0, 500, 430);

        setSize(new java.awt.Dimension(733, 455));
    ...
    private void loadData(){
        String kolom[] = {"No","Nama","Total"};
       DefaultTableModel dtm = new DefaultTableModel(null, kolom);
       String SQL = "SELECT id,atas_nama,harga FROM transaksi WHERE tgl_kembali IS NULL";
    ...
    private void ludData(){
        String kolom[] = {"No","Judul","Atas Nama","Harga","Tgl Pinjam","Tgl Kembali"};
       DefaultTableModel dtms = new DefaultTableModel(null, kolom);
       String SQL = "select * from transaksi where tgl_kembali is not null";
       ResultSet rs = DBConn.executeQuery(SQL);
       try{
           while(rs.next()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        // Iki save lur
        String SQL = "INSERT INTO transaksi (id,judul,atas_nama,harga,tgl_pinjam,tgl_kembali) "
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String SQL = "UPDATE transaksi SET tgl_kembali='"+tgl_ambil.getText()+"' WHERE id="+aidih;
        int status = DBConn.execute(SQL);
        if (status == 1) {
